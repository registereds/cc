...
/**
 * ListingIndex form base class.
 *
 * @method ListingIndex getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseListingIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('listing_index[%s]');
