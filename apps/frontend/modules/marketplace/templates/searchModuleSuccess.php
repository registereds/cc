<div class="clearfix">
    ...
    <div class="home-content rfloat">
        ...
        <div class="clearfix pagination">
  		Showing (<?php echo $pager->getFirstIndice() . ' - ' . $pager->getLastIndice(); ?>) of <span class="bold"><?php echo $pager->getNbResults(); ?></span> results.
...
<?php
            include_partial('partials/sideBarCategorySearch', array('categories' => $categories, 'categoryCounts' => $categoryCounts));
?>
