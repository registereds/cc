...
?>
 <div class="clearfix">
	<h1 class="underline-header">
		<span class="pushright item-detail-date"><?php echo $listing['created_at'];?></span>
	...
	<div class="clearfix counter">
	  ...
	  <ul >
	    <li><a  class="report-inappropriate  fancy-iframe" href="<?php echo url_for('pop/reportInappropriateForm');?>">Report Inappropriate Content</a></li>
	...
	<div class="item-side-column">
	  <div class="item-side-block first">
	    <?php include_partial('partials/listingImagesSb');?>
	  </div>
