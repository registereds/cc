...
// date: 2010/09/06 10:54:43
  ...
  'cache_dir' => '/Applications/MAMP/htdocs/cc/cache/backend/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/Applications/MAMP/htdocs/cc/apps/backend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Applications/MAMP/htdocs/cc/cache/backend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/Applications/MAMP/htdocs/cc/apps/backend/template',
)));
